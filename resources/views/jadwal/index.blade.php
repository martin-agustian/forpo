	...
	<section>
		<div class="row mt-4">
			...
			<div class="col-4">
				...
				<ul class="list-group list-group-forpo">
					@foreach ($hari_data as $key => $hari)
						<li 
							class="list-group-item {{ $hari->id == $hari_ini_data->id ? 'active' : '' }} js-hari" 
							data-hari="{{ $hari->id }}"
						>
							{{ ucfirst($hari->hari) }}
						</li>
